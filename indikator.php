<?php include("header.php");?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Home
        <small>Menyusun Indikator</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Menyusun Indikator OPD</h3>
              <hr>
            </div>
            <!-- /.box-header -->
            ...
            <button type="button" class="btn bg-navy margin" data-toggle="modal" data-target="#modal-indikator"><i class="fa fa-fw fa-plus-square-o"></i> Tambah</button>
            <div class="box-body">
