        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Menyusun Sasaran OPD</h3>
              <hr>
            </div>
            <!-- /.box-header -->
            ...
            <button type="button" class="btn bg-navy margin" data-toggle="modal" data-target="#modal-sasaran"><i class="fa fa-fw fa-plus-square-o"></i> Tambah</button>
            <div class="box-body">
